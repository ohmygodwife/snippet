...
# This file was *autogenerated* from the file knapsack_LLL.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_300 = Integer(300)
n=_sage_const_1 
last = matrix(ZZ,[[_sage_const_1 ]*n])
...
def LLL0(pubKey, encoded):
  ...
  res = A.LLL()
  print(res)
  print(res[_sage_const_0 ][:-_sage_const_1 ]) #need to remove last 0 element!
print('LLL0')
LLL0(pubKey, encoded)
...
def LLL1(publickey, enc):
    n = len(publickey)
    d = _sage_const_2 *identity_matrix(QQ,n,n)
    col = publickey+[enc]
    col = matrix(col).transpose()
    last = matrix(ZZ,[[_sage_const_1 ]*n])
    tmp = block_matrix(ZZ,[[d],[last]])
    grid = block_matrix(ZZ,[[tmp,col*(_sage_const_1 **_sage_const_300 )]])
    M = grid.LLL()
    print(M)
