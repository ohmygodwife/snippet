...
void mspecInit (MD5_CTX *context)          /* context */
{ 
 context->count[0] = context->count[1] = 0; 
 /* Load magic initialization constants. 
 */
 context->state[0] = 0xDEADBEEF; 
 context->state[1] = 0xDEADBEEF; 
 context->state[2] = 0xDEADBEEF; 
 context->state[3] = 0xDEADBEEF; 
} 

void mspec(MD5_CTX *context, unsigned char *input)
{
